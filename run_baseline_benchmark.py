#!/usr/bin/env python3
"""
Run the baseline benchmark before negation fix
"""
import subprocess
import sys
import os
...
def run_benchmark():
    """Run the mixed contradictions benchmark"""
    print("Running baseline benchmark (before negation fix)...")
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            if Path("mixed5k_baseline.csv").exists():
                print("✓ Results saved to mixed5k_baseline.csv")
